...
program.command('sauce <host-address> <path-to-sauce-config> [dir]')
  ...
  .option('--screen-resolution <resolution>', 'screen resolution to use. Default value is 1024x768. See https://saucelabs.com/docs/additional-config for details')
  ...
  .action(function(hostAddress, webdriverAddress, dir, options) {
    sauce(hostAddress, webdriverAddress, dir, options);
  });
